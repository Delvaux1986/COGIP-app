            ...
            <tbody class="font-weight-normal">
                <?php
                    ...
                    if($_SESSION['TypeUser'] === "Admin"){
                        ...
                        echo '<th><a href="'.URL.'Invoice/editInvoice/'.$inv['ID_Invoice'].'"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square text-secondary" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
