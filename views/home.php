                ...
                <tbody class="text-justify">
                    <?php
                        ...
                        foreach($contentInv as $content){
                            ...
                            echo '<th ><a href="http://localhost/COGIP-app/?p=companies/showCompany/'.$content['ID_Invoice'].'" >'.$content['ID_Invoice'].'</th></a>';
            ...
            <table class="table table-sm-responsive">
                ...
                <?php
                    ...
                    foreach($contentCont as $content){
                        echo '<tr class="d-flex flex-wrap justify-content-center align-item-center">';
                        echo '<th><a href="http://localhost/COGIP-app/?p=contacts/showContact/'.$content["ID_Contact"].'">'.$content['ID_Contact'].'</th></a>';
        ...
        <tbody>
            <?php
                foreach($contentComp as $content){
                    ...
                    echo '<tr class="d-flex flex-wrap justify-content-center align-item-center">';
                    echo '<th><a href="http://localhost/COGIP-app/?p=companies/showCompany/'.$content['ID_Company'].'"">'.$content['ID_Company'].'</th></a>';
                    echo '<th>'.$content['Name'].  '</th>';
